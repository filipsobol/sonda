<div class="grid grid-cols-12 gap-4 max-w-[1200px]">
  ...
  <button
    class="flex flex-col col-span-12 border border-gray-200 p-6 cursor-pointer hover:bg-gray-50"
  ...
  <button
    class="flex flex-col col-span-12 lg:col-span-6 border border-gray-200 p-6 cursor-pointer hover:bg-gray-50 disabled:bg-gray-100"
  ...
  <div class="flex flex-col col-span-12 lg:col-span-6 border border-gray-200 p-6 cursor-pointer hover:bg-gray-100">
