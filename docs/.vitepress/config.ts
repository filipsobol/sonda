...
export default defineConfig({
	...
	title: 'Sonda',
	description:
		'Universal bundle analyzer and visualizer. Works with Vite, Rollup, esbuild, webpack, Rolldown, Rspack, Next.js, Nuxt, Astro, SvelteKit and Angular CLI.',
	head: [
		...
		[
			'meta',
			{
				...
				content: 'Universal bundle analyzer and visualizer that works with most popular bundlers and frameworks.'
			}
		],
	...
	themeConfig: {
		...
		sidebar: [
			...
			{
				text: 'Blog',
				items: [{ text: 'What makes Sonda accurate?', link: '/blog/what-makes-sonda-accurate' }]
			}
		],
